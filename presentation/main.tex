...
\title[Short title]{Yelp Analysis} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Zhixuan Chi, Hengzhi Wu, Nguyen Cao, Madana Krishnan V.K} % Your name
\institute[CS Department, SFU] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
  CMPT732 Big Data Lab 1 - Course Project\\ % Your institution for the title page
\medskip
}
